...
class Augmentation():
    ...
    def  _get_geometric_transformation(self):
        ...
        transform = A.Compose(
            [
                A.RandomResizedCrop(height = params.height, width = params.width, scale = params.scale, ratio = params.ratio, interpolation=1, p=0.5),
    ...
    def generation(self, img, target, isReduced):
