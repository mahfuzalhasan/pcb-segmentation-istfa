...
class ASPP(nn.Module):
    def __init__(self, num_classes):
        ...
        self.conv_3x3_2 = nn.Conv2d(512, 256, kernel_size=3, stride=1, padding=5, dilation=5)
        self.bn_conv_3x3_2 = nn.BatchNorm2d(256)

        self.conv_3x3_3 = nn.Conv2d(512, 256, kernel_size=3, stride=1, padding=7, dilation=7)
